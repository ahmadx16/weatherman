...
def month_report(weather_dataset, year, month):
    ...
    avg_max_temp, month_date = get_mean_attr(weather_dataset, "Max TemperatureC", year, month)
    avg_min_temp, month_date = get_mean_attr(weather_dataset, "Min TemperatureC", year, month)
    avg_mean_humid, month_date = get_mean_attr(weather_dataset, "Mean Humidity", year, month)
...
def month_chart(weather_dataset, year, month):
    ...
    high_temps = get_attr_values(weather_dataset, "Max TemperatureC",  year, month)
    low_temps = get_attr_values(weather_dataset, "Min TemperatureC", year, month)

...
report_calculator = ReportCalculator(weather_dataset)
...
def test_get_attr_values():
    ...
    actual_min_2012_3 = report_calculator.get_attr_values( "Min TemperatureC", year=2012, month=3)
    actual_min_2012_4 = report_calculator.get_attr_values( "Min TemperatureC", year=2012, month=4)
...
def test_get_value():
    ...
    # Actual Values
    actual_max_2012 = report_calculator.get_value( "Max TemperatureC", "max", year=2012)
    actual_max_2014 = report_calculator.get_value( "Max TemperatureC", "max", year=2014)
...
def test_get_mean_attr():
    ...
    # Actual Values
    actual_max_mean_2012 = report_calculator.get_mean_attr( "Max TemperatureC", year=2012)
    actual_max_mean_2014 = report_calculator.get_mean_attr( "Max TemperatureC", year=2014)
